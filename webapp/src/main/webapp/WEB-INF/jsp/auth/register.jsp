                        ...
                        <div class="specialty-select">
                            <c:forEach items="${specialtyList}" var="specialty2">
                                <div class="specialty-option">
                                    <input type="checkbox" id="specialty-${specialty2.id}" name="specialties" value="${specialty2.id}" class="specialty-checkbox">
                                    <label for="specialty-${specialty2.id}" class="specialty-label">
                                        <spring:message code="${specialty2.key}"/>
                                    </label>
                                </div>
                            </c:forEach>
                        </div>
                    ...
                    <div class="specialty-select-container">
                        ...
                        <div class="specialty-select">
                            <c:forEach items="${coverageList}" var="coverage">
                                <div class="specialty-option">
                                    <input type="checkbox" id="<c:out value='coverage-${coverage.id}'/>" name="coverages" value="${coverage.id}" class="specialty-checkbox">
                                    <label for="<c:out value='coverage-${coverage.id}'/>" class="specialty-label"><c:out value="${coverage.name}"/></label>
                                </div>
                            </c:forEach>
                        </div>
                        ...
                        <form:select path="coverages" id="coverages" class="hidden-select" multiple="true">
                            <c:forEach items="${coverageList}" var="coverage">
                                <option value="${coverage.id}"><c:out value="${coverage.name}"/></option>
                            </c:forEach>
                        </form:select>
                    </div>
