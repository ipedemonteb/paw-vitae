...
<div class="page-container">
  <div class="register-container">
    ...
    <div class="register-content">
      <form:form modelAttribute="patientForm" method="post" action="${pageContext.request.contextPath}/register-patient" enctype="multipart/form-data" id="patientRegistrationForm">
          ...
          <div class="form-grid">
            <div class="form-field">
              ...
              <div class="input-container">
                ...
                <form:input path="name" id="name" required="true" class="input-field ${status.error ? 'input-error' : ''}" />
              </div>
            ...
            <div class="form-field">
              ...
              <div class="input-container">
                <i class="fas fa-user input-icon"></i>
                <form:input path="lastName" id="lastName" required="true" class="input-field ${status.error ? 'input-error' : ''}" />
              </div>
            ...
            <div class="form-field">
              ...
              <div class="input-container">
                ...
                <form:input path="email" id="email" required="true" class="input-field ${status.error ? 'input-error' : ''}" placeholder="email@vitae.com" />
              </div>
            ...
            <div class="form-field">
              ...
              <div class="input-container">
                ...
                <form:input path="phone" id="phone" required="true" class="input-field ${status.error ? 'input-error' : ''}" placeholder="+1 (123) 456-7890" />
              </div>
        ...
        <div class="form-section">
          ...
          <div class="form-grid">
            <div class="form-field">
              <label for="password" class="field-label">
                ...
                <div class="tooltip">
                  ...
                  <span class="tooltip-content"><spring:message code="register.passwordTooltip" /></span>
                </div>
              </label>
              <div class="input-container">
                <i class="fas fa-lock input-icon"></i>
                <form:password path="password" id="password" required="true" class="input-field ${status.error ? 'input-error' : ''}" />
              </div>
            ...
            <div class="form-field">
              ...
              <div class="input-container">
                <i class="fas fa-lock input-icon"></i>
                <form:password path="repeatPassword" id="repeatPassword" required="true" class="input-field ${status.error ? 'input-error' : ''}" />
              </div>
          ...
          <div class="coverage-grid">
            <c:forEach items="${coverageList}" var="coverage" varStatus="status">
              <div class="coverage-item">
                <form:radiobutton path="coverage" id="coverage-${coverage.id}" value="${coverage.id}" class="coverage-input" />
        ...
        <div class="form-actions">
          <button type="submit" id="registerButton" class="submit-button" onclick="this.disabled = true ; this.form.submit();">
          ...
          <div class="login-redirect">
            ...
            <a href="<c:url value='/login' />" class="login-link"><spring:message code="register.loginLink" /></a>
          </div>
        </div>
      </form:form>
    </div>
