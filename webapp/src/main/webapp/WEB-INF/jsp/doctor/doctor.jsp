...
<div class="container">
    <div class="success-card">
        <div class="success-header">
            ...
            <p class="thank-you"><spring:message code="registration.success.message"/><c:out value="${doctor.lastName}"/></p>
        </div>
