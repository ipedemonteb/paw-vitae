...
//import ar.edu.itba.paw.webapp.form.DoctorCertificatesForm;
...
//                                         @ModelAttribute("doctorProfileForm") final DoctorCertificatesForm doctorCertificatesForm) {
...
//    public ModelAndView updateDoctor(@Valid @ModelAttribute("doctorProfileForm") final DoctorCertificatesForm doctorCertificatesForm,
//                                     final BindingResult errors,
//                                     @ModelAttribute("loggedUser") final Doctor doctor
//    ) {
//        if (errors.hasErrors()) {
//            ModelAndView  mav = searchByDoctorId(doctor.getId(), doctor, doctorCertificatesForm);
//            mav.addObject("editMode", true);
//            return mav;
//        }
//        doctorProfileService.update(doctor, doctorCertificatesForm.getBiography(), doctorCertificatesForm.getDescription());
//        doctorCertificationService.update(doctor, doctorCertificatesForm.getCertificates());
//        doctorExperienceService.update(doctor, doctorCertificatesForm.getExperiences());
