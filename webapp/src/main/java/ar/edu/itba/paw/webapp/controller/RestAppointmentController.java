...
import static ar.edu.itba.paw.webapp.utils.ResponseUtils.buildPaginatedResponse;
...
public class RestAppointmentController {
    ...
    public Response listUpcoming(
        ...
        return buildPaginatedResponse(appointmentPage, uriInfo, AppointmentDTO::fromAppointment, OK);
    }
