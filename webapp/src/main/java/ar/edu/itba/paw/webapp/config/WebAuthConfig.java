...
public class WebAuthConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(final HttpSecurity http) throws Exception {
        http.sessionManagement()
                ...
                .authorizeRequests()
                    ...
                    .antMatchers("/doctor/dashboard/appointment-details/{id}", "/patient/dashboard/appointment-details/{id}", "/appointment/{id}/file/").access("@accessHandler.canViewAppointmentDetails(authentication, #id)")
                    .antMatchers("doctor/dashboard/appointment/cancel", "patient/dashboard/appointment/cancel").access("@accessHandler.canCancelAppointment(authentication, request.getParameter('appointmentId'))")
    ...
    public void configure(final WebSecurity web) throws Exception {
        web.ignoring()
                .antMatchers("/css/**", "/js/**", "/img/**","/favicon.ico",  "/src/main/favicon.ico","/doctor/*/image","**/image", "/error/**" );
    }
