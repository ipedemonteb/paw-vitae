    ...
    protected void configure(final HttpSecurity http) throws Exception {
        http.sessionManagement()
                ...
                .authorizeRequests()
                    ...
                    .antMatchers("doctor/dashboard/appointment/cancel", "patient/dashboard/appointment/cancel").access("@accessHandler.canViewAppointment(authentication, request.getParameter('appointmentId'))")
                    .antMatchers("doctor/dashboard/appointment/accept").access("@accessHandler.canViewAppointment(authentication, request.getParameter('appointmentId'))")
