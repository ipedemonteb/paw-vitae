...
//    }
    ...
    public void configure(final HttpSecurity http) throws Exception {
        http.sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS)
                ...
                .antMatchers(HttpMethod.PATCH,"/doctors/{id:\\d+}/offices/{officeId:\\d+}").access("hasRole('DOCTOR') and @accessHandler.isUser(authentication,#id)")
                .antMatchers(HttpMethod.DELETE,"/doctors/{id:\\d+}/offices/{officeId:\\d+}").access("hasRole('DOCTOR') and @accessHandler.isUser(authentication,#id)")
