...
public class LandingPageController {
    ...
    public ModelAndView mav(@ModelAttribute("loggedUser") final User user) {
        ...
        return new ModelAndView("landingPage/home")
                .addObject("specialties", specialties)
                .addObject("imageId", userService.getImageId(user).orElse(null))
                .addObject("ratings", ratingService.getFiveTopRatings())
                .addObject("doctorCount", doctorService.getAllDoctorsDisplayCount())
                .addObject("patientsCount", patientService.getAllPatientsDisplayCount());
    }
