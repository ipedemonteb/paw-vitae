...
export default function SpecialtyToggleGroup({currentSpecialties, specialties}: SpecialtyToggleGroupProps) {
    ...
    return (
        <ToggleGroup value={activeValue} onValueChange={setActiveValue} type="multiple" spacing={1.5} variant="outline" size="sm" className="flex-wrap p-3 border border-gray-400 bg-gray-100 ">
