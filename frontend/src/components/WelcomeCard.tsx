...
const loginWelcome = "bg-[var(--primary-color)] rounded-t-lg md:rounded-l-lg md:rounded-tr-[0] w-full md:w-1/2 md:py-6 lg:py-10 hidden md:block border-l border-y border-(--primary-color)";
