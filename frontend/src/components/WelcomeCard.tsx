...
const loginWelcome = "bg-[var(--primary-color)] rounded-t-lg md:rounded-l-lg md:rounded-tr-[0] md:max-w-xl w-full pt-8 md:py-4 hidden md:block";
...
const welcomeFeatures = "flex flex-col gap-4";
