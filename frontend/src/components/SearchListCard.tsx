...
const cardContainer = "flex flex-col items-stretch p-0 md:flex-row";
const iconContainer = "flex items-center justify-center px-8 py-6 border-b md:py-0 md:border-b-0 md:border-r";
const icon = "w-16 h-16";
const dataContainer = "flex flex-col items-center justify-center px-6 py-2 md:py-6 md:px-1 md:items-start";
...
const scheduleContainer = "flex flex-col justify-center items-stretch gap-2 px-8 py-6 border-t md:items-center md:py-4 md:ml-auto md:border-t-0 md:border-l";
            ...
            <div className={dataContainer}>
                ...
                {useDelayedBoolean(loadingSpecialties) ?
                    ...
                    errorSpecialties ? null
                        :
                        <SearchSpecialtyBadgeComponent specialties={fullyHydratedSpecialties} maxDisplay={3} />
                }
