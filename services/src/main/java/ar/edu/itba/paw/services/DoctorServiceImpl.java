...
public class DoctorServiceImpl implements DoctorService {
    ...
    public DoctorServiceImpl(DoctorDao doctorDao, PasswordEncoder passwordEncoder, ImageService imageService,
                             SpecialtyService specialtyService, CoverageService coverageService, DoctorOfficeService doctorOfficeService,UserService userService,@Lazy DoctorProfileService doctorProfileService) {
