...
public class DoctorOfficeAvailabilityDaoHibeImpl implements DoctorOfficeAvailabilityDao {
    ...
    public List<DoctorOfficeAvailabilitySlot> getByDoctorId(long doctorId) {
        return em.createQuery("SELECT d FROM DoctorOfficeAvailabilitySlot d JOIN d.office o WHERE o.doctor.id = :doctorId AND o.active = true AND o.removed IS NULL ORDER BY o.officeName, d.dayOfWeek, d.startTime",
                DoctorOfficeAvailabilitySlot.class)
