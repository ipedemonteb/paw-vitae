...
public class DoctorDaoTest {
    ...
    public void testCreateDoctor() {
        ...
        //Exercise
        Doctor doctor = doctorDao.create(NAME, LASTNAME, EMAIL, PASSWORD, PHONE, specialties, coverages);
    ...
    public void testGetByIdExists() {
        ...
        Coverage coverage = new Coverage(coverageId, "OSDE");
        Specialty specialty = new Specialty(specialtyId, "Cardiology");
        Doctor created = doctorDao.create(NAME, LASTNAME, EMAIL, PASSWORD, PHONE, List.of(specialty), List.of(coverage));
    ...
    public void testGetAll() {
        ...
        Coverage coverage = new Coverage(coverageId, "OSDE");
        Specialty specialty = new Specialty(specialtyId, "Cardiology");
        Doctor doctor = doctorDao.create(NAME, LASTNAME, EMAIL, PASSWORD, PHONE, List.of(specialty), List.of(coverage));
