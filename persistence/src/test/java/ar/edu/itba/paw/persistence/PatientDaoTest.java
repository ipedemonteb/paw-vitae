...
//        assertEquals(TEST_NAME, patient.getName());
//        assertEquals(TEST_LASTNAME, patient.getLastName());
//        assertEquals(TEST_EMAIL, patient.getEmail());
//        assertEquals(TEST_PHONE, patient.getPhone());
//        assertEquals(TEST_LANGUAGE, patient.getLanguage());
//        assertEquals(TEST_COVERAGE_ID, patient.getCoverage().getId());
//    }
//
//    @Test
...
//        assertEquals(last_name, maybePatient.get().getLastName());
