...
public class ClientDaoTest {
    ...
    public void setUp() {
        ...
        clientDao = new ClientDaoImpl(ds, mockAppointmentDao);
    ...
    public void testUpdateClient() {
        ...
        String updatedEmail = "jane.smith@test.com";
        String updatedPhone = "1188888888";

        //Exercise
        clientDao.updateClient(client.getId(), updatedName, updatedLastName, updatedEmail, updatedPhone, updatedCoverage);
